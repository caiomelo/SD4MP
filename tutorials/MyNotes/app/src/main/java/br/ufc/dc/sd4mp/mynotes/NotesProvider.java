...
/**
 * Created by Lincoln Rocha on 29/04/15.
 */
public class NotesProvider extends ContentProvider {

    static final String PROVIDER_NAME = "br.ufc.dc.sd4mp.provider.Note";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
             ...
             */
            case NOTES:
                return "vnd.android.cursor.dir/vnd.br.ufc.dc.sd4mp.mynotes.notes";
            /**
             * Get a particular note
             */
            case NOTE_ID:
                return "vnd.android.cursor.item/vnd.br.ufc.dc.sd4mp.mynotes.notes";
            default:
